        ...
        <div className="grid grid-cols-2 gap-4 h-full">
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    <h3 className="text-slate-500 text-xs font-bold uppercase tracking-tight mb-0.5">금일 면접자</h3>
                    <p className="text-2xl font-black text-slate-800 flex items-center justify-between">
                        <span>{data.todayIntervieweeCount}<span className="text-sm font-bold text-slate-400 ml-1">명</span></span>
            ...
            <div className="bg-white px-5 py-4 rounded-[20px] border border-slate-200 shadow-sm flex items-center gap-4">
                ...
                <div>
                    <h3 className="text-slate-500 text-xs font-bold uppercase tracking-tight mb-0.5">참여 부서</h3>
                    <p className="text-2xl font-black text-slate-800">
                        {data.todayHiringTeamCount}<span className="text-sm font-bold text-slate-400 ml-1">팀</span>
                    </p>
                </div>
            </div>
        </div>
    ...
    return (
        <div className="grid grid-cols-2 gap-4 h-full">
            ...
            <div className="bg-white px-5 py-4 rounded-[20px] border border-slate-200 shadow-sm flex items-center gap-4">
                ...
                <div>
                    <h3 className="text-slate-500 text-xs font-bold uppercase tracking-tight mb-0.5">총 지원자</h3>
                    <p className="text-2xl font-black text-slate-800">
                        {data.totalApplicants.toLocaleString()}<span className="text-sm font-bold text-slate-400 ml-1">명</span>
                    </p>
                </div>
            </div>
            ...
            <div className="bg-white px-5 py-4 rounded-[20px] border border-slate-200 shadow-sm flex items-center gap-4">
                ...
                <div>
                    <h3 className="text-slate-500 text-xs font-bold uppercase tracking-tight mb-0.5">진행 직무</h3>
                    <p className="text-2xl font-black text-slate-800">
                        {data.activeJobs}<span className="text-sm font-bold text-slate-400 ml-1">개</span>
                    </p>
                </div>
            </div>
        </div>
