  ...
  return (
    <section className="py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[2rem] bg-linear-to-br from-slate-900 via-indigo-950 to-violet-950 px-6 py-14 text-center shadow-2xl shadow-indigo-900/30 sm:px-12 sm:py-16">
          <div
