"""Simplify resume schema for AI context.

Revision ID: 8d2f4e9c1a0b
...
def downgrade() -> None:
    ...
    op.add_column(
        "resumes",
        sa.Column("disability", sa.String(length=50), nullable=True, comment="Disability"),
    )
    op.add_column(
        "resumes",
        sa.Column(
            ...
            sa.String(length=50),
            nullable=True,
            comment="Veteran eligibility",
        ),
    )
    op.add_column(
        "resumes",
        sa.Column("position_id", sa.Integer(), nullable=True, comment="First-choice position"),
    )
    op.create_foreign_key(
        "fk_resumes_position_id_positions",
        "resumes",
        "positions",
        ["position_id"],
        ["position_id"],
